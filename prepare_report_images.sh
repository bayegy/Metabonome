...
cpfirst 00-DataProcess/01-QC/After_shiftCor/loplot/pdf FiguresTablesForReport/图3-1.pdf
cp '00-DataProcess/01-QC/RSDresult/RSD variation.pdf' FiguresTablesForReport/图3-2.pdf
cp 00-DataProcess/02-Normlization/compound_wise_normlization.pdfdpi300.pdf FiguresTablesForReport/图3-3.pdf
...
cp 05-FoldChange/${report_group}/Volcano_features_importance.pdf FiguresTablesForReport/图7-1.pdf
...
cp 08-PathwayTopoEnrichment/${report_group}/ora_hyper_score_dpi300.pdf FiguresTablesForReport/图9-1.pdf
cp 08-PathwayTopoEnrichment/${report_group}/pathway_enrichment_and_topo_impact.pdf FiguresTablesForReport/图9-2.pdf
cpfirst 08-PathwayTopoEnrichment/${report_group}/dpi301.pdf FiguresTablesForReport/图9-3.pdf
cpfirst 08-PathwayTopoEnrichment/${report_group}/png FiguresTablesForReport/图9-4.png
cp 09-CorrelationAnalysis/all_group_clustered_pearson_cor_heatmap.pdf FiguresTablesForReport/图10-1.pdf
